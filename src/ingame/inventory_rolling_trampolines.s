...
InitMenuRollingBuffer:
    jsr.l InitMenuRollingBuffer_Impl
    rts
...
StartScrollDown:
    jsr.l StartScrollDown_Impl
    rts

StartScrollUp:
    jsr.l StartScrollUp_Impl
    rts
...
DrawWindow_Trampoline:
    jsr 0x80D9          ; vanilla DrawWindow at $01:80D9
    rtl

CheckCanUseItem_Trampoline:
    jsr 0xA25D          ; vanilla CheckCanUseItem at $01:A25D (sets $DB)
    rtl

DrawItemSlotInner_Trampoline:
    jsr 0xA1ED          ; vanilla DrawItemSlot inner at $01:A1ED
    rtl

TfrSpritesVblank_Trampoline:
    jsr 0x824F          ; vanilla @ $01:824F
    rtl

TfrBG2TilesVblank_Trampoline:
    jsr 0x9420          ; vanilla @ $01:9420
    rtl

DrawItemCursors_Trampoline:
    jsr 0xA105          ; vanilla @ $01:A105
    rtl

UpdateCtrlAfterScroll_Trampoline:
    jsr 0x82A5          ; vanilla @ $01:82A5
    rtl

ResetSprites_Trampoline:
    jsr 0x8D6A          ; vanilla @ $01:8D6A
    rtl
